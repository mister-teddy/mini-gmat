...
const ReadingComprehensionSubQuestion: FC<{ question: SubQuestion, onAnswer: (index: number) => any }> = ({ question, onAnswer }) => {
  ...
  return (
    <div className="w-full overflow-y-auto">
      ...
      <div className={`flex-none w-full grid grid-cols-1 gap-4`}>
        {question.answers.map((answer, i, items) => <Button key={i} className={`px-4`} loading={selected === i} onClick={() => setSelected(i)}>
